...
export default function ConversationsPage() {
  ...
  const toggleMode = async () => {
    ...
    await supabase.from('conversations').update({ mode: newMode }).eq('id', selected.id);
                ...
                {selected.mode === 'human' && (
                  <div className="p-3 border-t border-white/5 flex gap-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-violet-600 text-white text-xs font-semibold disabled:opacity-50"
                    >
                      Send
                    </button>
                  </div>
